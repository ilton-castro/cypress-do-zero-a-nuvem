...
Eu utilizei as versões v18.15.0 do 9.5.0 Node.js e do npm, respectivamente. Sugiro que você utilize versões iguais ou posteriores.
...
Execute npm test(ou, npm tpara a versão abreviada) para executar o teste no modo sem interface gráfica.
...
Este projeto foi criado com 💚 por Iltom .